...
# note: the module 'plotting' does not run correctly in Pycharm
...
# Task 1.14.18: Write a comprehension that rotates the elements of S by pi/4
...
# Task. 1.14.20: Write a comprehension that transforms the gray_image by
